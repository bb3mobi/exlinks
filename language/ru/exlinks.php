...
$lang = array_merge($lang, array(
	...
	'EXTERNAL_MESSAGE_TEXT'	=> 'Вы переходите по внешней ссылке: <span class="error">%s</span><br /><br />Убедитесь, что данная ссылка полностью является доверенной и ограждена от вредоносных влияний.<br />Если же ссылка показалась вам подозрительной, уважительная просьба сообщить об этом администрации.',
